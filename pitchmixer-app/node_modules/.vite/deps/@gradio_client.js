...
async function ce(e, s = void 0, t = [], n = false, o = void 0) {
  if (Array.isArray(e)) {
    let r = [];
    return await Promise.all(
      e.map(async (i, a) => {
...
async function Ct(e, s, t) {
  ...
  try {
    ...
    if (typeof process < "u" && process.versions && process.versions.node) {
      const p = await import("./__vite-browser-external-DYxpcVy9-WURJQMUS.js");
      i = (await import("./__vite-browser-external-DYxpcVy9-WURJQMUS.js")).resolve(process.cwd(), n.meta.path), r = await p.readFile(i);
    } else
      throw new Error(ut);
    const a = new Blob([r], {
...
var Pt = /^(?=[^]*\b[dD]iscussions{0,1}\b)(?=[^]*\b[dD]isabled\b)[^]*$/;
async function ke(e) {
  try {
    const s = await fetch(
...
function Kt(e, s = {}, t, n, o, r) {
  try {
    ...
    let W, b = null, T = false, _e = {}, B = typeof window < "u" && typeof document < "u" ? new URLSearchParams(window.location.search).toString() : "";
            ...
            let we = async function(ie) {
              try {
                ...
                console.error("Unexpected client exception", E), i({
                  ...
                  fn_index: d,
                  time: /* @__PURE__ */ new Date()
                }), ["sse_v2", "sse_v2.1", "sse_v3"].includes(O) && (de(X, Ue.abort_controller), X.open = false, a());
              }
            };
